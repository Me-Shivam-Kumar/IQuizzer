...
public class Non_verbal_resoning_question_activity extends AppCompatActivity {
    ...
    DatabaseReference myRef = database.getReference("SetsLogicalResoning");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_non_verbal_resoning_question_activity);
        ...
        myRef.child(category).child("questions").orderByChild("setNo").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(list.size()>0){
                    ...
                    nextBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(position==list.size()){
                                Intent srcoreIntent=new Intent(Non_verbal_resoning_question_activity.this,ScoreActivity.class);
                    ...
                    finish();
                    Toast.makeText(Non_verbal_resoning_question_activity.this,"No Questions",Toast.LENGTH_LONG).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Non_verbal_resoning_question_activity.this,databaseError.getMessage(),Toast.LENGTH_LONG).show();
                loadingDialog.dismiss();
                finish();
