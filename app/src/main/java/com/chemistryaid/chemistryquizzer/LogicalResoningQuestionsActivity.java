...
public class LogicalResoningQuestionsActivity extends AppCompatActivity {
        ...
        myRef.child(category).child("questions").orderByChild("setNo").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(list.size()>0){
                    ...
                    nextBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(position==list.size()){
                                Intent srcoreIntent=new Intent(LogicalResoningQuestionsActivity.this,ScoreActivity.class);
                    ...
                    finish();
                    Toast.makeText(LogicalResoningQuestionsActivity.this,"No Questions",Toast.LENGTH_LONG).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(LogicalResoningQuestionsActivity.this,databaseError.getMessage(),Toast.LENGTH_LONG).show();
                loadingDialog.dismiss();
                finish();
